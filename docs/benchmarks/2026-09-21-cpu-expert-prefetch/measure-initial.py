...
R=pathlib.Path('/tmp/werk-prefetch-validation');OLD=pathlib.Path('/tmp/werk-qwen-exact-regression'); H=OLD/'store';S=OLD/'seed';U=pathlib.Path('/home/philipbodenbach/.local/share/werk1112')
